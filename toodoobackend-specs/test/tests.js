...
var url = process.env.URL || 'http://localhost:8000/toodoos';
...
describe('Create Toodoo Item', function() {
  var result;
  ...
  it('should receive a location hyperlink', function() {
    return assert(result, 'header.location').to.match(/^https?:\/\/.+\/toodoos\/[\d]+$/);
  });
...
describe('Update Toodoo Item', function() {
  var location;
